...
$query = "SELECT phone FROM admin WHERE username = '$username'";
...
if (isset($_POST['update'])) {
    ...
    $query = "UPDATE admin SET phone = '$new_phone' WHERE username = '$username'";
...
<body>
    <form action="phone.php?username=<?php echo $username; ?>" method="post" class="box">
    	<center>
    		<h4>Change Phone</h4>
    	</center>
    	<center>
